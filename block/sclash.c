 ...
 */
  ...
  * different hardware queue. This is because sclash has shared
 ...
 static struct elevator_type sclash = {
     .ops = {
     ...
     .elevator_name = "sclash",
     .elevator_alias = "deadline",
     .elevator_features = ELEVATOR_F_ZBD_SEQ_WRITE,
     .elevator_owner = THIS_MODULE,
 };
 MODULE_ALIAS("sclash-iosched");
 
 static int __init deadline_init(void)
 {
     return elv_register(&sclash);
 }
 
 static void __exit deadline_exit(void)
 {
     elv_unregister(&sclash);
 }
