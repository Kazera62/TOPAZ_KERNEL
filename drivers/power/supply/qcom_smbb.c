 ...
 */
 ...
 // Optional helper to write input_suspend if needed manually
 static void smb_write_input_suspend(bool suspend)
 {
	 struct file *f;
	 mm_segment_t old_fs;
	 char *path = "/sys/class/qcom-battery/input_suspend";
	 char value = suspend ? '1' : '0';
	 loff_t pos = 0;
